  ...
  return (
    <>
      <motion.header
        ...
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        transition={{ duration: 0.6, ease: "easeOut", top: { duration: 0.4, ease: [0.25, 0.46, 0.45, 0.94] } }}
      >
            ...
            <div className="hidden lg:flex items-center gap-8">
              {navLinks.map((link) => (
                <a
                  ...
                  className="font-body text-sm text-brand-inverse/80 hover:text-brand-gold transition-colors duration-200 tracking-wide"
                >
                  {link.label}
                </a>
              ))}
            ...
            <div className="flex flex-col items-center justify-center min-h-screen gap-8 px-6">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="font-display text-3xl text-brand-inverse hover:text-brand-gold transition-colors"
