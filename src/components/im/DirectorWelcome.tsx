...
export function DirectorWelcome() {
  ...
  return (
    <section className="relative z-10 bg-brand-cream dark:bg-brand-navy/40 py-16 sm:py-24 lg:py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <StaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={staggerChildVariants} className="flex flex-col justify-center relative z-10">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="font-body text-sm sm:text-base text-brand-body dark:text-brand-muted leading-relaxed">
                    At IM Attorneys, we believe that exceptional legal representation begins with a deep commitment to understanding our clients' needs and delivering tailored solutions.
                  </p>

                  <p className="font-body text-sm sm:text-base text-brand-body dark:text-brand-muted leading-relaxed">
                    Our team provides strategic legal counsel, professional advocacy, and practical solutions designed to protect and advance our clients’ interests.
                  </p>

                  <p className="font-body text-sm sm:text-base text-brand-body dark:text-brand-muted leading-relaxed">
                    Whether you require representation in complex matters or trusted legal guidance, we are committed to standing beside you every step of the way.
                  </p>
                </motion.div>
                ...
                <motion.button
                  ...
                  className="btn-premium mt-6 self-start"
